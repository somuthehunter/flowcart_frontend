...
import brandLogoMinimal from "@/assets/images/logos/logo_minimal.svg";
...
export function getFullBrandLogo(
    type: "normal" | "white" | "minimal" | "icon" | "print"
) {
    switch (type) {
        case "normal":
        ...
        case "minimal":
            return getImage("brandLogoMinimal");
        case "icon":
